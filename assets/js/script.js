 ...
 * We enjoy creating the Card Table to create 2 div which will be displayed into the Help Bubble
 */
...
function ShowResult(Result, Withsound) {
    ...
    // We remove the existing element to put the result image instead
    document.getElementById("ShowResult").remove();
    let NewDiv = document.createElement('div');
